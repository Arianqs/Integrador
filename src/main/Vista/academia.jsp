...
<script>
    function showVideo() {
        ...
        container.innerHTML = `
            ...
            width="50%" 
            height="85%" 
            src="https://www.youtube.com/embed/NPnImV1d7KE?autoplay=1" 
            frameborder="0" 
...
<%
    ...
    Pelicula pelicula = metodos.getPeliculaPorNombre("My Hero Academia: Ahora es tu Turno");
...
%>
   ...
   <div class="movie-title"><%= pelicula != null ? pelicula.getTitulo() : "Título no disponible" %> <span class="rating"></span> <a href="#" class="btn-comprar" onclick="scrollToSelect()">Comprar</a>
       <div class="details">Anime | 1hrs 40min | APT</div>
  </div><br><br><br><br>
<div class="container">
    ...
    <div class="info-container">
        ...
        <div class="info-section">
            ...
            <span class="available">XTREME</span>
        </div>
    </div>
</div>
  ...
  <div class="funcion">La función perfecta para ti..</div><br><br>
        ...
        <div class="combobox-item">
                ...
                <select id="ciudad" name="ciudad">
                    ...
                    <%
                        List<String> listaCiudades = metodos.obtenerCiudadesPorPelicula("My Hero Academia: Ahora es tu Turno");
       ...
       <script>
            ...
            function continuar() {
                ...
                var pelicula = "My Hero Academia: Ahora es tu Turno";
