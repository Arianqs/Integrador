...
.video-background {
    ...
    height: 50%; /* Ocupa el alto completo */
    max-width: 400px; /* Ajusta el ancho máximo que desees */
    margin-top:200px;
...
<div class="texto" onclick="showVideo()">
    <img src="https://img.youtube.com/vi/8iRcmQ8xwII/hqdefault.jpg" alt="Mira el trailer" class="video-background">
...
<script>
    function showVideo() {
        ...
        container.innerHTML = `
            <iframe width="50%" height="85%" style="margin-top: 38px;"  src="https://www.youtube.com/embed/8iRcmQ8xwII?autoplay=1" 
...
<%
    ...
    Pelicula pelicula = metodos.getPeliculaPorNombre("La Chica del Alquiler");
...
<br><br>
  <div class="movie-title"><%= pelicula != null ? pelicula.getTitulo() : "Título no disponible" %> <span class="rating"></span> <a href="#" class="btn-comprar" onclick="scrollToSelect()">Comprar</a>
       <div class="details">Comedia | 1hrs 35min | +12</div>
  </div><br><br><br><br>
<div class="container">
  ...
  <div class="funcion">La función perfecta para ti..</div><br><br>
        ...
        <div class="combobox-item">
                ...
                <select id="ciudad" name="ciudad">
                    ...
                    <%
                        List<String> listaCiudades = metodos.obtenerCiudadesPorPelicula("La Chica del Alquiler");
           ...
           <div class="combobox-item">
            ...
            <div class="combobox-item">
                ...
                <select id="horario" name="horario">
                    ...
                    <%
                        List<String> listaHorarios = metodos.obtenerHorariosPorPelicula(4);
       ...
       <script>
            ...
            function continuar() {
                ...
                var pelicula = "La Chica del Alquiler";
