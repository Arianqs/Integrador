...
<div class="texto" onclick="showVideo()">
    <img src="https://img.youtube.com/vi/oXTO2a9sNpg/hqdefault.jpg" alt="Mira el trailer" class="video-background">
...
<script>
    function showVideo() {
        ...
        container.innerHTML = `
            ...
            width="50%" 
            height="85%" 
            src="https://www.youtube.com/embed/oXTO2a9sNpg?autoplay=1" 
            frameborder="0" 
...
<%
    ...
    Pelicula pelicula = metodos.getPeliculaPorNombre("Guasón 2: Folie À Deux");
...
%>
   ...
   <div class="movie-title"><%= pelicula != null ? pelicula.getTitulo() : "Título no disponible" %> <span class="rating"></span> <a href="#" class="btn-comprar" onclick="scrollToSelect()">Comprar</a>
       <div class="details">Drama | 2hrs 30min | +14</div>
  </div><br><br><br><br>
<div class="container">
  ...
  <div class="funcion">La función perfecta para ti..</div><br><br>
        ...
        <div class="combobox-item">
                ...
                <select id="ciudad" name="ciudad">
                    ...
                    <%
                        List<String> listaCiudades = metodos.obtenerCiudadesPorPelicula("Guasón 2: Folie À Deux");
       ...
       <script>
            ...
            function continuar() {
                ...
                var pelicula = "Guasón 2: Folie À Deux";
