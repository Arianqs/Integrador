...
<div class="texto" onclick="showVideo()">
    <img src="https://img.youtube.com/vi/IifEvV2DxH0/hqdefault.jpg" alt="Mira el trailer" class="video-background">
...
<script>
    function showVideo() {
        ...
        container.innerHTML = `
            ...
            width="50%" 
            height="85%" 
            src="https://www.youtube.com/embed/IifEvV2DxH0?autoplay=1" 
            frameborder="0" 
...
<%
    ...
    Pelicula pelicula = metodos.getPeliculaPorNombre("No Hables con Extraños");
...
%>
   ...
   <div class="movie-title"><%= pelicula != null ? pelicula.getTitulo() : "Título no disponible" %> <span class="rating"></span> <a href="#" class="btn-comprar" onclick="scrollToSelect()">Comprar</a>
       <div class="details">Suspenso | 1hrs 50min | +14</div>
  </div><br><br><br><br>
<div class="container">
  ...
  <div class="funcion">La función perfecta para ti..</div><br><br>
        ...
        <div class="combobox-item">
                ...
                <select id="ciudad" name="ciudad">
                    ...
                    <%
                        List<String> listaCiudades = metodos.obtenerCiudadesPorPelicula("No Hables con Extraños");
       ...
       <script>
            ...
            function continuar() {
                ...
                var pelicula = "No Hables con Extraños";
