...
<div class="texto" onclick="showVideo()">
    <img src="https://img.youtube.com/vi/seR1tYQ7ycU/hqdefault.jpg" alt="Mira el trailer" class="video-background">
    ...
    function showVideo() {
        ...
        container.innerHTML = `
            <iframe 
                width="50%" 
                height="85%" 
                src="https://www.youtube.com/embed/seR1tYQ7ycU" 
                frameborder="0" 
...
<%
    ...
    Pelicula pelicula = metodos.getPeliculaPorNombre("Beetlejuice Beetlejuice");
...
%>
   ...
   <div class="movie-title"><%= pelicula != null ? pelicula.getTitulo() : "Título no disponible" %> <span class="rating"></span> <a href="#" class="btn-comprar" onclick="scrollToSelect()">Comprar</a>
       <div class="details">Terror | 1hrs 50min | +14</div>
  </div><br><br><br><br>
<div class="container">
        ...
        <div class="filter-container"  id="selectSection">
            ...
            <div class="combobox-item">
                ...
                <select id="ciudad" name="ciudad">
                    ...
                    <%
                        List<String> listaCiudades = metodos.obtenerCiudadesPorPelicula("Beetlejuice Beetlejuice");
    ...
    <button type="button" id="continuarButton" class="btn" onclick="continuar()">Continuar</button>
       ...
       <script>
            ...
            function continuar() {
                ...
                var pelicula = "Beetlejuice Beetlejuice";
