    ...
    function showVideo() {
        ...
        container.innerHTML = `
            <iframe 
                width="50%" 
                height="85%" 
                src="https://www.youtube.com/embed/sEXyPinA4lE" 
                frameborder="0" 
...
<%
    ...
    Pelicula pelicula = metodos.getPeliculaPorNombre("Robot Salvaje");
...
%>
   ...
   <div class="movie-title"><%= pelicula != null ? pelicula.getTitulo() : "Título no disponible" %> <span class="rating"></span> <a href="#" class="btn-comprar" onclick="scrollToSelect()">Comprar</a>
       <div class="details">Animación | 1hrs 45min | APT</div>
  </div><br><br><br><br>
<div class="container">
        ...
        <div class="filter-container"  id="selectSection">
            ...
            <div class="combobox-item">
                ...
                <select id="ciudad" name="ciudad">
                    ...
                    <%
                        List<String> listaCiudades = metodos.obtenerCiudadesPorPelicula("Robot Salvaje");
