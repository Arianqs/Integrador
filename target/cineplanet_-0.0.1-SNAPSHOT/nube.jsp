...
<div class="texto" onclick="showVideo()">
    <img src="https://img.youtube.com/vi/wAUovzpw-PQ/hqdefault.jpg" alt="Mira el trailer" class="video-background">
...
<script>
    function showVideo() {
        ...
        container.innerHTML = `
            ...
            width="50%" 
            height="85%" 
            src="https://www.youtube.com/embed/wAUovzpw-PQ?autoplay=1" 
            frameborder="0" 
...
<%
    ...
    Pelicula pelicula = metodos.getPeliculaPorNombre("Sube a mi nube");
...
%>
   ...
   <div class="movie-title"><%= pelicula != null ? pelicula.getTitulo() : "Título no disponible" %> <span class="rating"></span> <a href="#" class="btn-comprar" onclick="scrollToSelect()">Comprar</a>
       <div class="details">Drama | 1hrs 50min | +14</div>
  </div><br><br><br><br>
<div class="container">
