...
<%
    ...
    Pelicula pelicula = metodos.getPeliculaPorNombre("Infierno en Altamar");
...
%>
   ...
   <div class="movie-title"><%= pelicula != null ? pelicula.getTitulo() : "Título no disponible" %> <span class="rating"></span> <a href="#" class="btn-comprar" onclick="scrollToSelect()">Comprar</a>
       <div class="details">Terror | 1hrs 40min | +18</div>
  </div><br><br><br><br>
<div class="container">
    ...
    <div class="info-container">
        ...
        <div class="info-section">
            ...
            <span class="available">SCREENX</span>
        ...
        <div class="filter-container"  id="selectSection">
            ...
            <div class="combobox-item">
                ...
                <select id="ciudad" name="ciudad">
                    ...
                    <%
                        List<String> listaCiudades = metodos.obtenerCiudadesPorPelicula("Infierno en Altamar");
    ...
    <button type="button" id="continuarButton" class="btn" onclick="continuar()">Continuar</button>
       ...
       <script>
            ...
            function continuar() {
                ...
                var pelicula = "Infierno en Altamar";
